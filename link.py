...
class Convertor:
  def __init__(self, partner, master):
    ...
    self.folder_entry = Entry(self.child_frame, font=text_font_6)
    ...
    self.file_entry = Entry(self.child_frame, font=text_font_6)
    ...
    self.point_entry = Entry(self.child_frame, font=text_font_6)
